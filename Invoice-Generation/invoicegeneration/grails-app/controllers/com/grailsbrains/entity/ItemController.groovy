...
class ItemController {
    ...
    def saveItem(){
      ...
      /*  def item1= params.itemx
        println("DFDFFFFFFFFFFFFFFFFFF"+item1)
    def ite = Item.findById(item1)
        println("DFDsssssssssssssssssssssssssssssssssssssF"+ite)
        render view: "_itemtemps.gsp", model: [item:ite ]
*/
    }
